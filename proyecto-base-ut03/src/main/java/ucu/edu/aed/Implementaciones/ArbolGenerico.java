...
public class ArbolGenerico<T extends Comparable<T>> implements TArbolGenerico{
    ...
    public boolean esDescendiente(T ancestro,T descendiente) {
        ...
        return nodoAncestro.buscar(descenciente) != null; //si encuentro el descendiente dentro del subarbol del ancestro devuelve true, sino false
    }
